 ...
 * @returns {void}
 */
export function parseWordAsync(filename: string, deleteOfficeDist?: boolean): void;
 ...
 * @returns {void}
 */
export function parsePowerPointAsync(filename: string, deleteOfficeDist?: boolean): void;
 ...
 * @returns {void}
 */
export function parseExcelAsync(filename: string, deleteOfficeDist?: boolean): void;
 ...
 * @returns {void}
 */
export function parseOpenOfficeAsync(filename: string, deleteOfficeDist?: boolean): void;
 ...
 * @returns {void}
 */
export function parseOfficeAsync(filename: string, deleteOfficeDist?: boolean): void;
